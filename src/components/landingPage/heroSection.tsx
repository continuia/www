...
const HeroSection = () => (
    <Box
        sx={{
            ...
            boxShadow: "0 4px 32px 0 var(--shadow-md, rgba(124,58,237,0.06))",
            overflow: "hidden",
            position: "relative",
        }}
    >
        ...
        >
            ...
            <Box flex={1} sx={{ maxWidth: 650 }}>
                ...
                >
                    When Medical Decisions<br />Matter Most
                </Typography>
                <Typography
                    variant="h6"
                    sx={{
                ...
                >
                    {features.map((feature) => (
                        <Stack
                            ...
                            key={feature}
                        >
                            <CheckCircleIcon sx={{ color: "var(--neutral-800, #64748b)", fontSize: 20 }} />
                            <Typography
                                variant="body2"
                                sx={{
                                    color: "var(--primary-800, #4c1d95)",
