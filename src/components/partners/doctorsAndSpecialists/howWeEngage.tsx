...
const steps = [
  {
    number: "1",
    title: "Simple Upload",
    description: "Records uploaded securely with no platform integration needed",
  },
  {
    number: "2",
    title: "Quick Turnaround",
    description: "Licensed clinicians return neutral summaries within hours or days",
  },
  {
    number: "3",
    title: "Zero Disruption",
    description: "No workflow changes or additional training required",
  },
  {
    number: "4",
    title: "Full Compliance",
    description: "HIPAA compliance, BAA coverage, and audit trails included",
  },
];
