...
const steps = [
  {
    ...
    description: "A white-labeled solution through your platform",
  },
  {
    number: "2",
    title: "Recommended Add-On",
    description: "A recommended add-on in your client portfolio",
  },
  {
    number: "3",
    title: "Standalone Service",
    description: "A standalone service offered to select client populations",
  },
  {
    number: "4",
    title: "Fast Onboarding",
    description: "Fast onboarding and customization",
  },
];
