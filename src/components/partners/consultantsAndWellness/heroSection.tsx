...
// Preload the image
import heroIllustration from "../../../assets/partners/consultatntsAndWellness.webp";
    ...
    >
      <Stack direction={{ xs: "column", md: "row" }} alignItems="center" justifyContent="space-between" spacing={6} sx={{ width: "100%" }}>
        ...
        <MotionBox initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeLeft} sx={{ flex: 1, maxWidth: 650 }}>
          ...
          >
            Offer Your Clients a High-Trust, Low-Friction Medical Add-On
          </Typography>
          <Typography
            variant="h6"
            sx={{
          ...
          >
            ...
            <br />
            <br />
            Use it as part of your navigation layer, or as a standalone trust-builder.
          </Typography>
        </MotionBox>
        ...
        >
          ...
          <Box
            ...
            alt="Consultants and wellness partnership"
            loading="eager"
            fetchPriority="high"
