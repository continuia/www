...
// Preload the image
import heroIllustration from "../../../assets/partners/healthPlanTPAs.webp";
    ...
    >
      <Stack direction={{ xs: "column", md: "row" }} alignItems="center" justifyContent="space-between" spacing={6} sx={{ width: "100%" }}>
        ...
        <MotionBox initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeLeft} sx={{ flex: 1, maxWidth: 650 }}>
          ...
          >
            Reduce Avoidable Costs and Improve Member Decision-Making
          </Typography>
          <Typography
            variant="h6"
            sx={{
          ...
          >
            ...
            <br />
            <br />
            Available as PMPM benefit, usage-based credit pool, or opt-in case model. Our reporting supports utilization, impact tracking, and dispute resolution.
          </Typography>
        </MotionBox>
        ...
        >
          ...
          <Box
            ...
            alt="Health plan and TPA partnership"
            loading="eager"
            fetchPriority="high"
