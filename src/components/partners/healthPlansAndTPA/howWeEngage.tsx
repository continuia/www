...
const steps = [
  {
    number: "1",
    title: "PMPM Benefit",
    description: "A PMPM benefit across your population for comprehensive coverage",
  },
  {
    number: "2",
    title: "Case-Based Credits",
    description: "A case-based credit pool for flexible utilization management",
  },
  {
    number: "3",
    title: "Opt-In Service",
    description: "An opt-in service for high-risk members requiring additional support",
  },
  {
    number: "4",
    title: "Full Support",
  ...
  return (
    ...
    >
      <Box sx={{ maxWidth: 1200, mx: "auto", textAlign: "center", mb: "var(--space-12)" }}>
        ...
        >
          Continuia can be offered through multiple engagement models to fit your needs
        </Typography>
      </Box>
      <Box
        sx={{
