...
const steps = [
  {
    ...
    description: "Work directly with facility leadership or medical director to define clear touchpoints",
  },
  {
    number: "2",
    title: "Clear Triggers",
    description: "Define when to trigger Continuia review: post-incident, admission, or care planning",
  },
  {
    number: "3",
    title: "Pilot Programs",
    description: "Fast, flexible implementation with limited cases, scaling based on demonstrated impact",
  },
  {
    number: "4",
    title: "Full Compliance",
    description: "HIPAA-compliant, audit-friendly service with structured governance and response SLAs",
  },
];
