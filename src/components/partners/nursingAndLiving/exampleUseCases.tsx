...
const useCases = [
  {
    ...
    description: "A nurse faces uncertainty in managing a complex medication list for a resident with multiple conditions.",
  },
  {
    icon: <GavelOutlined fontSize="inherit" sx={{ color: "var(--text-inverse)" }} />,
    title: "Hospitalization Decisions",
    description: "A family questions whether hospitalization is necessary after a fall, seeking reassurance about care decisions.",
  },
  {
    icon: <SyncAltOutlined fontSize="inherit" sx={{ color: "var(--text-inverse)" }} />,
    title: "Cognitive Changes",
    description: "Staff managing a resident with early signs of cognitive decline or behavioral changes requiring expert guidance.",
  },
  {
    icon: <PlaylistAddCheckOutlined fontSize="inherit" sx={{ color: "var(--text-inverse)" }} />,
    title: "Care Transitions",
    description: "A new resident transitioning from recent hospital discharge needs continuity of evaluation and care planning.",
  },
];
