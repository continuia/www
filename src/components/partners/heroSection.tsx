    ...
    >
      <Stack direction={{ xs: "column", md: "row" }} alignItems="center" justifyContent="space-between" spacing={6} sx={{ width: "100%" }}>
        ...
        <MotionBox initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeLeft} sx={{ flex: 1, maxWidth: 650 }}>
          ...
          >
            Our comprehensive partnership network connects healthcare organizations, medical professionals, and innovative technology providers to create a collaborative ecosystem that enhances patient care delivery and operational excellence. Through strategic alliances, we foster an environment where medical expertise meets cutting-edge innovation.
            <br />
            <br />
          ...
          <Stack direction={{ xs: "column", sm: "row" }} spacing={2} mb={3}>
            {/* Button components are commented out in original - keeping as is */}
          </Stack>
        </MotionBox>
        ...
        >
          ...
          <Box
            ...
            alt="Healthcare partnership network"
            loading="eager"
            fetchPriority="high"
