...
const CTASection = () => (
  ...
  >
    ...
    >
      Ready to Empower Your Members with Expert Reviews?
    </Typography>
    <Typography
      variant="subtitle1"
      sx={{
    ...
    >
      Partner with Continuia to provide your community with the clarity and support they deserve on their medical journey.{" "}
    </Typography>
