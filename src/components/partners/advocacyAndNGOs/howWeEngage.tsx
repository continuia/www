...
const steps = [
  {
    ...
    description: "Funded by the advocacy group or external grants",
  },
  {
    number: "2",
    title: "Case-Based Support",
    description: "For members in critical transitions",
  },
  {
    number: "3",
    title: "Referral Programs",
    description: "Discounted or free reviews for eligible patients",
  },
  {
    number: "4",
