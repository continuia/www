...
import { ArticleOutlined, FactCheckOutlined, VisibilityOutlined } from "@mui/icons-material";
import { motion, type Variants } from "framer-motion";

const featureList = [
  {
    icon: <FactCheckOutlined fontSize="inherit" sx={{ color: "var(--text-inverse)" }} />,
    title: "Non-Judgmental Reviews",
    description: "Structured second opinions that prioritize clarity, not control. Our licensed physicians review existing records and provide plain-language summaries.",
  },
  {
  ...
  },
  {
    ...
    description: "Ideal for organizations advocating for transparency, equity, and access in complex or overlooked areas of care.",
  },
];
...
export const HowContinuiaSupports: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        Empathy-driven, physician-led second opinions that prioritize clarity, not control
      </Typography>
      <Box
        sx={{
          display: "flex",
