...
import { ShieldOutlined, ForumOutlined, VisibilityOutlined, SupportAgentOutlined, VolunteerActivismOutlined } from "@mui/icons-material";
...
const reasonCards = [
  {
    icon: <VisibilityOutlined fontSize="inherit" sx={{ color: "var(--primary-400)" }} />, // Clarity
    title: "Clarity",
    description: "Without judgment",
  },
  {
    icon: <SupportAgentOutlined fontSize="inherit" sx={{ color: "var(--primary-400)" }} />, // Support
    title: "Support",
    description: "Without bureaucracy",
  },
  {
    icon: <ForumOutlined fontSize="inherit" sx={{ color: "var(--primary-400)" }} />, // Understanding
    title: "Understanding",
    description: "Clear guidance",
  },
  {
    icon: <VolunteerActivismOutlined fontSize="inherit" sx={{ color: "var(--primary-400)" }} />, // Empathy
    title: "Empathy",
...
export const WhyThisPartnerMatters: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        Supporting communities through their most challenging medical journeys
      </Typography>
