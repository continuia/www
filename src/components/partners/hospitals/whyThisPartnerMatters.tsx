...
const reasonCards = [
  {
    ...
    description: "Direct impact on patient outcomes",
  },
  {
    icon: <StarOutline fontSize="inherit" sx={{ color: "var(--primary-400)" }} />,
    title: "Reputation",
    description: "Trust and credibility in community",
  },
  {
...
export const WhyThisPartnerMatters: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        Why this group is important to Continuia&apos;s mission
      </Typography>
      ...
      >
        ...
        >
          ...
          <Typography sx={{ color: "var(--text-secondary)", fontSize: "var(--text-base)", maxWidth: 480 }}>Hospitals are at the frontlines of care and face increasing demands for safer discharges, reduced readmissions, and improved patient satisfaction. Their ability to uphold quality standards directly impacts outcomes, reputation, and compliance.</Typography>
        </Box>
