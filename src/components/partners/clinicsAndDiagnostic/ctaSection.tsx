...
const CTASection = () => {
  ...
  return (
    ...
    >
      ...
      >
        Ready to Add Value to Every Report?
      </Typography>
      <Typography
        variant="subtitle1"
        sx={{
      ...
      >
        Join outpatient clinics and diagnostic centers who trust Continuia to extend patient engagement and build lasting relationships.{" "}
      </Typography>
