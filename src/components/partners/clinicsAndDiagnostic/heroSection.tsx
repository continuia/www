...
import heroIllustration from "../../../assets/partners/clinicsAndDiagnostic.webp";
  ...
  >
    <Stack direction={{ xs: "column", md: "row" }} alignItems="center" justifyContent="space-between" spacing={6} sx={{ width: "100%" }}>
      ...
      <MotionBox initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.22 }} variants={fadeLeft} sx={{ flex: 1, maxWidth: 650 }}>
        ...
        >
          Diagnostic centers and outpatient clinics often produce the most critical data in a patient’s care journey—but interpretation gaps lead to patient anxiety and care drop-offs. <br />
          <br />
          <br />
          Continuia bridges that gap. With one click, your patient can get a structured, physician-led second opinion on their imaging, pathology, or lab report. It’s easy, fast, and builds long-term loyalty.
          <br />
          <br />
          You already provide the data. Let us help deliver the clarity.{" "}
        </Typography>
      </MotionBox>
      {/* Right: Illustration */}
      <MotionPaper
