...
import {
  TouchAppOutlined, // For Single Click Access
  MenuBookOutlined, // For Plain Language Summaries
  EmojiEventsOutlined, // For Competitive Differentiation
...
const featureList = [
  ...
  },
  {
    ...
    description: "Our summaries are delivered in plain language, avoiding medical jargon and legal risk, while increasing patient understanding and satisfaction.",
  },
  {
    icon: <EmojiEventsOutlined fontSize="inherit" sx={{ color: "var(--text-inverse)" }} />,
    title: "Competitive Differentiation",
    description: "This light-touch layer builds trust, improves patient follow-through, and differentiates your center in a competitive market.",
  },
];
