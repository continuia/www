...
const CTASection = () => {
  ...
  return (
    ...
    >
      ...
      >
        Ready to Transform Medical Tourism with Pre-Travel Clinical Reviews?
      </Typography>
      <Typography
        variant="subtitle1"
        sx={{
      ...
      >
        Join leading medical tourism providers who trust Continuia for confident, well-informed patient journeys.
      </Typography>
