...
// Preload the image
import heroIllustration from "../../../assets/partners/tourismAndHealth.webp";
    ...
    >
      <Stack direction={{ xs: "column", md: "row" }} alignItems="center" justifyContent="space-between" spacing={6} sx={{ width: "100%" }}>
        ...
        <MotionBox initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeLeft} sx={{ flex: 1, maxWidth: 650 }}>
          ...
          >
            Patients traveling across borders or seeking elective care want clarity before they commit. Continuia lets your concierge or medical travel company offer second opinions before a single ticket is booked.
            <br />
            <br />
            Structured reviews help match patients to the right facility, avoid unnecessary travel, and reduce friction in complex or uncertain cases.
            <br />
            <br />
            We support multi-lingual intake, global physician networks, and white-labeled coordination.
          </Typography>
        </MotionBox>
        ...
        >
          ...
          <Box
            ...
            alt="Tourism and health travel partnership"
            loading="eager"
            fetchPriority="high"
